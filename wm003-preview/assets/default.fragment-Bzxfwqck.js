import{t as e}from"./shaderStore-D-XQlhUT.js";import{n as t,t as ee}from"./clipPlaneFragment-DVK0wgyZ.js";import{n as te,t as ne}from"./fogFragment-CISE_m3s.js";import{n as re,t as ie}from"./meshUboDeclaration-DYEo1Glw.js";import{n as ae,r as oe,t as se}from"./logDepthDeclaration-CTCYTVLm.js";import{t as ce}from"./helperFunctions-gEnZbjN3.js";var n=`decalFragmentDeclaration`,r=`#ifdef DECAL
...
`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=a);var ue={name:i,shader:a},o=`objectIdFunctions`,s=`highp vec4 encodeObjectId(highp float objectId) {
...
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=s);var de={name:o,shader:s},c=`prePassDeclaration`,l=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=l);var fe={name:c,shader:l},u=`oitDeclaration`,d=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#extension GL_EXT_draw_buffers : require
...
#endif
`;e.IncludesShadersStore[u]||(e.IncludesShadersStore[u]=d);var pe={name:u,shader:d},f=`lightFragmentDeclaration`,p=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=p);var me={name:f,shader:p},m=`lightUboDeclaration`,h=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
result.Diffuse=LTCEvaluateWithEmission( normal,viewDir,position,mat3( 1.0 ),rectCoords,texFilteredMap );return result;}`;e.IncludesShadersStore[g]||(e.IncludesShadersStore[g]=_);var ge={name:g,shader:_},v=`clusteredLightingFunctions`,y=`struct ClusteredLight {vec4 vLightData;vec4 vLightDiffuse;vec4 vLightSpecular;vec4 vLightDirection;vec4 vLightFalloff;};
#define inline
...
`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=y);var _e={name:v,shader:y},b=`lightsFragmentFunctions`,x=`struct lightingInfo
{vec3 diffuse;
#ifdef SPECULARTERM
vec3 specular;
#endif
...
return result;}
#endif
`;e.IncludesShadersStore[b]||(e.IncludesShadersStore[b]=x);var ve={name:b,shader:x},S=`shadowsFragmentFunctions`,C=`#ifdef SHADOWS
...
#endif
#endif
`;e.IncludesShadersStore[S]||(e.IncludesShadersStore[S]=C);var ye={name:S,shader:C},w=`samplerFragmentDeclaration`,T=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStore[w]||(e.IncludesShadersStore[w]=T);var be={name:w,shader:T},E=`fresnelFunction`,D=`#ifdef FRESNEL
float computeFresnelTerm(vec3 viewDirection,vec3 worldNormal,float bias,float power)
{float fresnelTerm=pow(bias+abs(dot(viewDirection,worldNormal)),power);return clamp(fresnelTerm,0.,1.);}
#endif
`;e.IncludesShadersStore[E]||(e.IncludesShadersStore[E]=D);var xe={name:E,shader:D},O=`reflectionFunction`,k=`vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
#endif
`;e.IncludesShadersStore[O]||(e.IncludesShadersStore[O]=k);var Se={name:O,shader:k},A=`imageProcessingDeclaration`,j=`#ifdef EXPOSURE
...
#endif
`;e.IncludesShadersStore[A]||(e.IncludesShadersStore[A]=j);var Ce={name:A,shader:j},M=`imageProcessingFunctions`,N=`#if defined(COLORGRADING) && !defined(COLORGRADING3D)
/** 
...
return result;}`;e.IncludesShadersStore[M]||(e.IncludesShadersStore[M]=N);var we={name:M,shader:N},P=`textureRepetitionFunctions`,F=`#if TEXTURE_REPETITION_MODE>0
...
`;e.IncludesShadersStore[P]||(e.IncludesShadersStore[P]=F);var Te={name:P,shader:F},I=`bumpFragmentMainFunctions`,L=`#ifndef TEXRD_DEFINED
#define TEXRD(s,uv) texture2D(s,uv)
#define TEXRD_DEFINED
#endif
...
#endif
`;e.IncludesShadersStore[I]||(e.IncludesShadersStore[I]=L);var Ee={name:I,shader:L},R=`bumpFragmentFunctions`,z=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStore[R]||(e.IncludesShadersStore[R]=z);var De={name:R,shader:z},B=`bumpFragment`,V=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;e.IncludesShadersStore[B]||(e.IncludesShadersStore[B]=V);var Oe={name:B,shader:V},H=`decalFragment`,U=`#ifdef DECAL
#ifdef GAMMADECAL
...
#endif
`;e.IncludesShadersStore[H]||(e.IncludesShadersStore[H]=U);var ke={name:H,shader:U},W=`depthPrePass`,G=`#ifdef DEPTHPREPASS
gl_FragColor=vec4(0.,0.,0.,1.0);return;
#endif
`;e.IncludesShadersStore[W]||(e.IncludesShadersStore[W]=G);var Ae={name:W,shader:G},K=`lightFragment`,q=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[K]||(e.IncludesShadersStore[K]=q);var je={name:K,shader:q},J=`logDepthFragment`,Y=`#ifdef LOGARITHMICDEPTH
gl_FragDepthEXT=log2(vFragmentDepth)*logarithmicDepthConstant*0.5;
#endif
`;e.IncludesShadersStore[J]||(e.IncludesShadersStore[J]=Y);var Me={name:J,shader:Y},X=`oitFragment`,Z=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;e.IncludesShadersStore[X]||(e.IncludesShadersStore[X]=Z);var Ne={name:X,shader:Z},Q=`defaultPixelShader`,$=`#define CUSTOM_FRAGMENT_EXTENSION
...
`;e.ShadersStore[Q]||(e.ShadersStore[Q]=$);var Pe=[le,ue,re,ie,oe,de,fe,pe,ae,ce,me,he,ge,_e,ve,ye,be,xe,Se,Ce,we,Te,Ee,De,t,se,te,ee,Oe,ke,Ae,je,Me,ne,Ne];for(let t of Pe)e.IncludesShadersStore[t.name]||(e.IncludesShadersStore[t.name]=t.shader);var Fe={name:Q,shader:$};export{Fe as defaultPixelShader};