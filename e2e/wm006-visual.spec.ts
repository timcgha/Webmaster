...
test('WM006 nine visible attacks, dodge directions, audio and held-input edges',async({page})=>{
 ...
 await writeFile(`${out}/poses-and-audio.json`,JSON.stringify({poses,audio,errors,limitations:'Screenshots show actual animated poses; WebAudio scheduling observed, perceived sound quality remains sponsor judgment.'},null,2));
});
