import{t as e}from"./shaderStore-D-XQlhUT.js";import{n as t,t as ee}from"./clipPlaneFragment-Ct2VqHzk.js";import{n as te,t as n}from"./fogFragment-EikOP4pH.js";import{n as ne,t as re}from"./meshUboDeclaration-ClF6XIke.js";import{n as r,r as ie,t as ae}from"./logDepthDeclaration-BKlEAogj.js";import{t as oe}from"./helperFunctions-BH8P-eyq.js";var i=`objectIdFunctions`,a=`fn encodeObjectId(objectId: f32)->vec4f {
...
`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=a);var se={name:i,shader:a},o=`prePassDeclaration`,s=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[o]||(e.IncludesShadersStoreWGSL[o]=s);var ce={name:o,shader:s},c=`oitDeclaration`,l=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#define MAX_DEPTH 99999.0
var oitDepthSamplerSampler: sampler;var oitDepthSampler: texture_2d<f32>;var oitFrontColorSamplerSampler: sampler;var oitFrontColorSampler: texture_2d<f32>;
#endif
`;e.IncludesShadersStoreWGSL[c]||(e.IncludesShadersStoreWGSL[c]=l);var le={name:c,shader:l},u=`lightUboDeclaration`,d=`#ifdef LIGHT{X}
struct Light{X}
{vLightData: vec4f,
vLightDiffuse: vec4f,
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[u]||(e.IncludesShadersStoreWGSL[u]=d);var ue={name:u,shader:d},f=`ltcHelperFunctions`,p=`fn LTCUv(N: vec3f,V: vec3f,roughness: f32)->vec2f {var LUTSIZE: f32=64.0;var LUTSCALE: f32=( LUTSIZE-1.0 )/LUTSIZE;var LUTBIAS:f32=0.5/LUTSIZE;var dotNV:f32=saturate( dot( N,V ) );var uv:vec2f=vec2f( roughness,sqrt( 1.0-dotNV ) );uv=uv*LUTSCALE+LUTBIAS;return uv;}
...
`;e.IncludesShadersStoreWGSL[f]||(e.IncludesShadersStoreWGSL[f]=p);var de={name:f,shader:p},m=`clusteredLightingFunctions`,h=`struct ClusteredLight {vLightData: vec4f,
vLightDiffuse: vec4f,
vLightSpecular: vec4f,
vLightDirection: vec4f,
vLightFalloff: vec4f,}
...
`;e.IncludesShadersStoreWGSL[m]||(e.IncludesShadersStoreWGSL[m]=h);var fe={name:m,shader:h},g=`clusteredLightingCompute`,_=`#if defined(CLUSTLIGHT{X}) && defined(CLUSTLIGHT_BATCH) && CLUSTLIGHT_BATCH>0
...
return result;}
#endif
`;e.IncludesShadersStoreWGSL[g]||(e.IncludesShadersStoreWGSL[g]=_);var pe={name:g,shader:_},v=`lightsFragmentFunctions`,y=`struct lightingInfo
{diffuse: vec3f,
#ifdef SPECULARTERM
specular: vec3f,
#endif
...
#endif
`;e.IncludesShadersStoreWGSL[v]||(e.IncludesShadersStoreWGSL[v]=y);var me={name:v,shader:y},b=`shadowsFragmentFunctions`,x=`#ifdef SHADOWS
#ifndef SHADOWFLOAT
...
#endif
`;e.IncludesShadersStoreWGSL[b]||(e.IncludesShadersStoreWGSL[b]=x);var he={name:b,shader:x},S=`samplerFragmentDeclaration`,C=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStoreWGSL[S]||(e.IncludesShadersStoreWGSL[S]=C);var ge={name:S,shader:C},w=`fresnelFunction`,T=`#ifdef FRESNEL
fn computeFresnelTerm(viewDirection: vec3f,worldNormal: vec3f,bias: f32,power: f32)->f32
{let fresnelTerm: f32=pow(bias+abs(dot(viewDirection,worldNormal)),power);return clamp(fresnelTerm,0.,1.);}
#endif
`;e.IncludesShadersStoreWGSL[w]||(e.IncludesShadersStoreWGSL[w]=T);var _e={name:w,shader:T},E=`reflectionFunction`,D=`fn computeFixedEquirectangularCoords(worldPos: vec4f,worldNormal: vec3f,direction: vec3f)->vec3f
...
#endif
`;e.IncludesShadersStoreWGSL[E]||(e.IncludesShadersStoreWGSL[E]=D);var ve={name:E,shader:D},O=`imageProcessingDeclaration`,k=`#ifdef EXPOSURE
...
#endif
`;e.IncludesShadersStoreWGSL[O]||(e.IncludesShadersStoreWGSL[O]=k);var ye={name:O,shader:k},A=`imageProcessingFunctions`,j=`#if TONEMAPPING==3
...
return vec4f(rgb,result.a);}`;e.IncludesShadersStoreWGSL[A]||(e.IncludesShadersStoreWGSL[A]=j);var M={name:A,shader:j},N=`textureRepetitionFunctions`,P=`#if TEXTURE_REPETITION_MODE>0
...
`;e.IncludesShadersStoreWGSL[N]||(e.IncludesShadersStoreWGSL[N]=P);var be={name:N,shader:P},F=`bumpFragmentMainFunctions`,I=`#ifndef TEXRD_DEFINED
fn TEXRD(t: texture_2d<f32>,ts: sampler,uv: vec2f)->vec4f {return textureSample(t,ts,uv);}
#define TEXRD_DEFINED
#endif
...
#endif
`;e.IncludesShadersStoreWGSL[F]||(e.IncludesShadersStoreWGSL[F]=I);var xe={name:F,shader:I},L=`bumpFragmentFunctions`,R=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStoreWGSL[L]||(e.IncludesShadersStoreWGSL[L]=R);var Se={name:L,shader:R},z=`bumpFragment`,B=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;e.IncludesShadersStoreWGSL[z]||(e.IncludesShadersStoreWGSL[z]=B);var Ce={name:z,shader:B},V=`decalFragment`,H=`#ifdef DECAL
...
#endif
`;e.IncludesShadersStoreWGSL[V]||(e.IncludesShadersStoreWGSL[V]=H);var we={name:V,shader:H},U=`depthPrePass`,W=`#ifdef DEPTHPREPASS
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[U]||(e.IncludesShadersStoreWGSL[U]=W);var Te={name:U,shader:W},G=`lightFragment`,K=`#ifdef LIGHT{X}
#if defined(SHADOWONLY) || defined(LIGHTMAP) && defined(LIGHTMAPEXCLUDED{X}) && defined(LIGHTMAPNOSPECULAR{X})
#else
var diffuse{X}: vec4f=light{X}.vLightDiffuse;
#define CUSTOM_LIGHT{X}_COLOR 
#if defined(PBR) && defined(CLUSTLIGHT{X})
{let sliceIndex=min(getClusteredSliceIndex(light{X}.vSliceData,fragmentInputs.vViewDepth),CLUSTLIGHT_SLICES-1);info=computeClusteredLighting{X}(
lightDataTexture{X},
light{X}.vLightData,
...
#endif
#elif defined(CLUSTLIGHT{X})
{let sliceIndex=min(getClusteredSliceIndex(light{X}.vSliceData,fragmentInputs.vViewDepth),CLUSTLIGHT_SLICES-1);info=computeClusteredLighting{X}(lightDataTexture{X},viewDirectionW,normalW,light{X}.vLightData,vec2u(light{X}.vSliceRanges[sliceIndex].xy),glossiness);}
#endif
#endif
#ifdef PROJECTEDLIGHTTEXTURE{X}
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[G]||(e.IncludesShadersStoreWGSL[G]=K);var Ee={name:G,shader:K},q=`logDepthFragment`,J=`#ifdef LOGARITHMICDEPTH
fragmentOutputs.fragDepth=log2(fragmentInputs.vFragmentDepth)*uniforms.logarithmicDepthConstant*0.5;
#endif
`;e.IncludesShadersStoreWGSL[q]||(e.IncludesShadersStoreWGSL[q]=J);var Y={name:q,shader:J},X=`oitFragment`,Z=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;e.IncludesShadersStoreWGSL[X]||(e.IncludesShadersStoreWGSL[X]=Z);var De={name:X,shader:Z},Q=`defaultPixelShader`,$=`#include<defaultUboDeclaration>
...
`;e.ShadersStoreWGSL[Q]||(e.ShadersStoreWGSL[Q]=$);var Oe=[ne,re,ie,se,ce,le,r,oe,ue,de,fe,pe,me,he,ge,_e,ve,ye,M,be,xe,Se,t,ae,te,ee,Ce,we,Te,Ee,Y,n,De];for(let t of Oe)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);var ke={name:Q,shader:$};export{ke as defaultPixelShaderWGSL};