...
- Name: wm003.spec.ts >> WM003 simulated PlayStation complete route, controller pause save load and keyboard fallback
- Location: .wm004-derived\e2e\wm003.spec.ts:59:1
...
- main [ref=e2]:
  ...
  - generic:
    - region "Current objective":
      - text: CLIMB & PULL 6 / 6
      - strong: Jump onto your moved crate, then jump onto the gold finish ledge.
    - region "Health 100 percent":
      - text: HERO ENERGY
      - strong: 100 / 100
    - generic:
      - generic: Slot 1 • Normal
      - generic: "-2, 0, -52 • 27 FPS"
    ...
    - region "Climb and Pull status":
      - strong: CLIMB C / R1 • PULL Q / L1
      - generic: Pull released.
  - status: "Checkpoint: Pull the pale crate toward the gold floor mark. Use it as a step to the finish ledge."
```
