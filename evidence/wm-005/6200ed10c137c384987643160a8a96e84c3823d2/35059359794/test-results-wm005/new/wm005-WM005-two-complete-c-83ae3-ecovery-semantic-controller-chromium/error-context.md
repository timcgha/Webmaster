...
- Name: wm005.spec.ts >> WM005 two complete circuit laps plus ground recovery semantic-controller
- Location: e2e\wm005.spec.ts:54:31

# Error details

```
Error: wm005-controller-missed-street 1280x720: .objective-card overlaps .swing-card
