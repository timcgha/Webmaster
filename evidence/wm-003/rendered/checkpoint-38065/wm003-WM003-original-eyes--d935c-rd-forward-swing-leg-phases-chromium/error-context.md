...
- Name: wm003.spec.ts >> WM003 original eyes palette body lattice and actual backward forward swing-leg phases
- Location: e2e/wm003.spec.ts:457:1
...
- main [ref=e2]:
  ...
  - generic:
    ...
    - region "Swing status":
      ...
      - strong: Attached to training-ring
      - generic: Web attached. Steer gently. Let go to sail onward.
    - region "Climb and Pull status":
      - strong: CLIMB C / RB • PULL Q / LB
      - generic: "South of practice: follow the Climb & Pull arrows."
  - status: "Checkpoint: Climb & Pull: turn toward the south ring. Jump, hold your swing web, then release over the far roof."
```
...
```ts
  ...
  3   | const out = "evidence/wm-003/captures";
