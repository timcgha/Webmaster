...
#endif
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=n);var r={name:t,shader:n},i=`bakedVertexAnimationDeclaration`,a=`#ifdef BAKED_VERTEX_ANIMATION_TEXTURE
...
#endif
`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=a);var o={name:i,shader:a},s=`clipPlaneVertexDeclaration`,c=`#ifdef CLIPPLANE
...
#endif
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=c);var l={name:s,shader:c},u=`instancesVertex`,d=`#ifdef INSTANCES
...
#endif
#endif
`;e.IncludesShadersStore[u]||(e.IncludesShadersStore[u]=d);var f={name:u,shader:d},p=`bonesVertex`,m=`#ifndef BAKED_VERTEX_ANIMATION_TEXTURE
...
#endif
#endif
`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=m);var h={name:p,shader:m},g=`bakedVertexAnimation`,_=`#ifdef BAKED_VERTEX_ANIMATION_TEXTURE
{
#ifdef INSTANCES
...
#endif
`;e.IncludesShadersStore[g]||(e.IncludesShadersStore[g]=_);var v={name:g,shader:_},y=`clipPlaneVertex`,b=`#ifdef CLIPPLANE
