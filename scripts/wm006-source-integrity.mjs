...
fs.mkdirSync('evidence/wm-006',{recursive:true});
const report={source:git('rev-parse','HEAD'),tree:git('rev-parse','HEAD^{tree}'),baseline:'6aff5802736b5c12380102a70a38794838397d7d',checked:files.length,status:discrepancies.length?'FAIL':'PASS',discrepancies,files};
fs.writeFileSync('evidence/wm-006/source-integrity.json',JSON.stringify(report,null,2)+'\n');
