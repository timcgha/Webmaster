...
fs.mkdirSync('evidence/wm-005',{recursive:true});const report={source:git('rev-parse','HEAD'),tree:git('rev-parse','HEAD^{tree}'),baseline:'a63ad0e05ce12d2b42ff22e97d39de4af51d4b08',checked:files.length,status:'PASS',files};fs.writeFileSync('evidence/wm-005/source-integrity.json',JSON.stringify(report,null,2)+'\n');console.log(JSON.stringify({...report,files:undefined}));
