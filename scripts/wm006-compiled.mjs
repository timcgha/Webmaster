...
const base='/Webmaster/wm006-preview/',url='http://127.0.0.1:4177'+base+'?test=1&diagnostics=1',prefix='webmaster.wm006-preview.v1:';
const out=path.resolve('.wm006-payload'),reportDir='evidence/wm-006/compiled';fs.mkdirSync(reportDir,{recursive:true});
